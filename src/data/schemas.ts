...
export const tripSchema = z.object({ ...base, id: z.string(), clientName: z.string(), destination: z.string(), startDate: z.string(), endDate: z.string(), currency: z.string(), status: z.string(), salePrice: moneySchema, wholesaleCost: moneySchema, amountPaid: moneySchema, amountDue: moneySchema.optional(), profit: moneySchema.optional(), salePriceMinor: z.number().safe(), wholesaleCostMinor: z.number().safe(), amountPaidMinor: z.number().safe(), amountDueMinor: z.number().safe(), profitMinor: z.number().safe(), moneyScale: z.literal(2), revision: z.number().int().nonnegative(), travelers: z.unknown().optional(), travelersEncoding: z.string().optional(), updatedAtMicros: z.string().optional(), attachments: z.unknown().optional() }).passthrough();

...
export default function LegalPage({ kind }: { kind: 'privacy' | 'terms' }) {
  ...
  return (
    <>
      ...
      <MarketingSection className="border-b border-slate-200 bg-[var(--marketing-hero)] pt-16 sm:pt-20"><MarketingContainer><SectionHeading level={1} eyebrow="MyDesck PRO" title={title} description={intro} /></MarketingContainer></MarketingSection>

...
export default function SecurityPage() {
  ...
  return (
    <>
      ...
      <MarketingSection className="border-b border-slate-200 bg-[var(--marketing-hero)] pt-16 sm:pt-20"><MarketingContainer><SectionHeading eyebrow={copy.security.eyebrow} title={copy.security.title} description={copy.security.intro} /></MarketingContainer></MarketingSection>
      <MarketingSection>

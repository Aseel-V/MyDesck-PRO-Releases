...
const modes: Record<IndustrySlug, 'travel' | 'supermarket' | 'restaurant' | 'auto-repair'> = {
  'travel-agencies': 'travel', supermarkets: 'supermarket', restaurants: 'restaurant', 'auto-repair': 'auto-repair',
};
    ...
    <>
      ...
      <MarketingSection className="border-b border-slate-200 bg-[var(--marketing-hero)] pt-14 sm:pt-20">
        <MarketingContainer className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <ProductFrame initialMode={modes[slug]} fixed label={solution.visualLabel} />
        </MarketingContainer>
      </MarketingSection>
      <MarketingSection>

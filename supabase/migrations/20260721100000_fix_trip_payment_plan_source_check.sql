-- Forward-only migration to fix PostgreSQL 23514: new row for relation "trip_payment_plans" violates check constraint "trip_payment_plans_source_check"
-- Sets source = 'native' to satisfy CHECK (source IN ('native', 'legacy')) in public.save_trip_transaction.
